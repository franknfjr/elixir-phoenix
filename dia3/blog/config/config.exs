...
config :blog, BlogWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "PUY6Q9eJuC8IuzMDb0NOGUW4KJl+IEvhCW7EK9KQLdW9A/FzFOe1lunYmdlG1FeN",
...
config :coherence,
  user_schema: Blog.Coherence.User,
  repo: Blog.Repo,
  module: Blog,
  web_module: BlogWeb,
  router: BlogWeb.Router,
  messages_backend: BlogWeb.Coherence.Messages,
  logged_out_url: "/",
...
config :coherence, BlogWeb.Coherence.Mailer,
